        ...
        for (let index = 0; index < topRowNumbers.length; index++) {
          ...
          if (Math.abs(topRowNumber[1][0] - symbolCol) <= 1 ||
            ...
            if (!topRowNumber[2]) {
              sum += topRowNumber[0];
              topRowNumber[2] = true;
              console.log(`Found ${topRowNumber[0]} at ${topRowNumber[1]} reading symbol ${symbol[0]} at row ${rowIndex + 1} and col ${symbolCol + 1}`);
            }
          }
        }
      }
      ...
      for (let index = 0; index < currentRowNumbers.length; index++) {
        ...
        if (Math.abs(currentRowNumber[1][0] - symbolCol) <= 1 ||
          ...
          if (!currentRowNumber[2]) {
            ...
            console.log(`Found ${currentRowNumber[0]} at ${currentRowNumber[1]} reading symbol ${symbol[0]} at row ${rowIndex + 1} and col ${symbolCol + 1}`);
          }
        }
      }
      // check bottom row
        ...
        for (let index = 0; index < bottomRowNumbers.length; index++) {
          ...
          if (Math.abs(bottomRowNumber[1][0] - symbolCol) <= 1 ||
            ...
            if (!bottomRowNumber[2]) {
              ...
              console.log(`Found ${bottomRowNumber[0]} at ${bottomRowNumber[1]} reading symbol ${symbol[0]} at row ${rowIndex + 1} and col ${symbolCol + 1}`);
            }
          }
        }
      }
